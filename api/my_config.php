...
define("WP_IDX", "wp_");
define("wp_secret", NULL);
define("wp_token", NULL);
define("mailgun_token", NULL);
define("mailgun_region", "eu");
define("mailgun_domain", null);
define("mailgun_from_email", null);
define("mailgun_from_name", null);